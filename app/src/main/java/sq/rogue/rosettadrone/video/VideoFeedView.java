...
//                DisplayMetrics displaymetrics = viewIn.getContext().getResources().getDisplayMetrics();
//                RelativeLayout preview_video_parent = (RelativeLayout) findViewById(R.id.view_live_stream_layout);
//                LayoutParams layoutParams = (LayoutParams) preview_video_parent.getLayoutParams();
//                layoutParams.width = displaymetrics.widthPixels;
//                layoutParams.height = displaymetrics.heightPixels;
//                viewIn.setLayoutParams(layoutParams);
//            }
//        });
    }
